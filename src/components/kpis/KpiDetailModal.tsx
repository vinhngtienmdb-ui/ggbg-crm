    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="bg-white rounded-xl border border-slate-200 shadow-xl w-full max-w-xl overflow-hidden my-8 animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 space-y-5 max-h-[80vh] overflow-y-auto">
          {/* Progress Card */}
          <div className="p-5 bg-gradient-to-r from-slate-900 to-indigo-950 text-white rounded-2xl shadow-lg space-y-3 border border-indigo-800/40">
          ...
          {/* Notes */}
          {kpi.notes && (
            <div className="p-3.5 bg-blue-50/60 border border-blue-100 rounded-2xl text-xs space-y-1">
              <span className="font-bold text-blue-900 flex items-center gap-1">
                <FileText className="w-3.5 h-3.5 text-blue-600" /> Ghi Chú Kế Hoạch:
              </span>
              <p className="text-slate-700 leading-relaxed">{kpi.notes}</p>
            </div>
          )}
