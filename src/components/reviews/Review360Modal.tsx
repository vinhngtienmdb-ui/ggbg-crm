        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
              <div>
                <label className="block text-[11px] font-semibold text-slate-700 mb-1">Họ & Tên Người Đánh Giá *</label>
                <input
                  type="text"
                  value={reviewerName}
              ...
              <div>
                <label className="block text-[11px] font-semibold text-slate-700 mb-1">Chức Danh Người Đánh Giá</label>
                <input
                  type="text"
                  value={reviewerRole}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {session.criteria_framework.map((crit) => {
                ...
                return (
                  <div key={crit.id} className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-2">
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1">🌟 Điểm Mạnh Nổi Bật Của Nhân Sự:</label>
              <textarea
                rows={2}
                value={strengths}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1">🚀 Điểm Cần Cải Thiện & Khuyến Nghị Phát Triển:</label>
              <textarea
                rows={2}
                value={improvements}
