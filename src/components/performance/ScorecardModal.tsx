      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-2xl w-full max-w-3xl overflow-hidden my-8 animate-in fade-in zoom-in duration-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300">
                Đồng bộ kết quả KPI, tự đánh giá công việc & quy trình phê duyệt đa cấp
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
            <div>
              <span className="font-bold text-slate-700 block">Quy Trình & Trạng Thái Phiếu Đánh Giá:</span>
              <span className="text-slate-500 text-[11px]">
                {formData.status === 'DRAFT_SELF' && 'Cá nhân đang tự nhập công việc & tự chấm điểm ngày 01'}
                ...
                {formData.status === 'FINAL_LOCKED' && 'Bảng điểm đã chốt vĩnh viễn & tự tính Lương P3'}
              </span>
            </div>
            ...
            >
              ...
              <option value="REVIEWING_HR">📋 HR Hoàn Thiện & Rà Soát</option>
              <option value="FINAL_LOCKED">🔒 Khóa Bảng Điểm & Tính Lương P3</option>
            </select>
          </div>
          ...
          <div className="p-4 bg-white border border-slate-200 rounded-2xl space-y-3">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2">
              ...
              <button
                ...
                className="px-2.5 py-1 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 rounded-lg text-xs font-bold flex items-center gap-1 transition-all active:scale-95"
              >
              ...
              <div key={item.id} className="p-3 bg-slate-50 border border-slate-200/80 rounded-xl space-y-2 text-xs">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 px-3 py-1 bg-white border border-slate-200 rounded-lg font-bold text-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-600"
                  />
                  <div className="flex items-center gap-1 shrink-0">
                    <span className="text-[11px] font-bold text-slate-500">Tự chấm:</span>
                    <input
                      type="number"
                      min={0}
                      max={10}
            ...
            {workItems.length === 0 && (
              <p className="text-center py-4 text-slate-400 text-xs italic">
                Chưa có công việc nào được thêm. Nhấp &apos;Thêm Công Việc&apos; để cá nhân tự báo cáo kết quả.
              </p>
            )}
          </div>
          ...
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-slate-200 pb-2">
              ...
              <button
                ...
                className="px-3 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold flex items-center gap-1 shadow-sm transition-all active:scale-95"
              >
                <RefreshCw className="w-3.5 h-3.5" /> Đồng Bộ Kết Quả KPI
              </button>
            </div>
          ...
          <div className="p-4 bg-gradient-to-r from-slate-900 to-indigo-950 text-white rounded-2xl shadow-xl space-y-4 border border-indigo-800/40">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
              <div>
                <span className="text-slate-300 font-bold block mb-1">Mức Lương P3 Mục Tiêu (Gốc):</span>
                <input
                  type="number"
                  min={0}
                  step={500000}
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    Hạng {computedGrade} ({Math.round(multiplier * 100)}% P3)
                  </span>
                </div>
              </div>
            </div>
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">
              Ghi Chú Đánh Giá Của Quản Lý & HR
            </label>
            <textarea
              rows={2}
