  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200 px-2 py-1 flex items-center justify-around shadow-lg">
      ...
      <button
        ...
        className="flex flex-col items-center justify-center py-1 px-2 min-w-[56px] rounded-xl text-[10px] font-bold text-slate-400 hover:text-blue-600 transition-all active:scale-95"
      >
