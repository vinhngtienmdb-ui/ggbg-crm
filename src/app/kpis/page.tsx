        ...
        <div className="flex items-center gap-2">
          {activeMainTab === 'KPI_LIST' && (
            <button
              ...
              className="px-4 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-xs font-bold shadow-lg shadow-amber-600/30 flex items-center gap-2 transition-all active:scale-95"
            >
                  ...
                  {filteredKpis.map((kpi) => {
                    ...
                    return (
                      <tr key={kpi.id} className="hover:bg-slate-50 transition-colors">
                        <td className="p-3">
                          <p className="font-bold text-slate-900 text-sm">{kpi.kpi_name}</p>
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 w-full md:w-auto justify-end">
              <button
                ...
                className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold rounded-xl flex items-center gap-1.5"
              >
              ...
              <button
                ...
                className="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl flex items-center gap-1.5 shadow-md"
              >
        ...
        <div className="bg-white p-6 rounded-2xl border border-purple-200/80 shadow-sm space-y-6 text-xs font-medium">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-purple-50/50 p-5 rounded-2xl border border-purple-200">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-bold shadow-lg shadow-purple-600/30 flex items-center gap-2 transition-all active:scale-95 shrink-0"
            >
              ...
              <tbody className="divide-y divide-slate-100">
                {scorecards.map((sc) => (
                  <tr key={sc.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-3 text-center">
                      <span className="px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-800 font-bold text-[10.5px] border border-emerald-300">
                        ⚡ Đã Đồng Bộ Auto
                      </span>
                    </td>
                  </tr>
