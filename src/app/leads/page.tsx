...
const initialLeads: Lead[] = [
  {
    ...
    assigned_sale_name: 'Trần Văn Hoàng',
...
export default function LeadsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-2 rounded-2xl border border-slate-200/80 shadow-sm flex items-center justify-between gap-2 overflow-x-auto text-xs font-bold">
                      ...
                      >
                        ...
                        <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-1">
                          ...
                          <button
                            ...
                            className="px-2 py-1 bg-amber-500 hover:bg-amber-600 text-white font-bold text-[10px] rounded flex items-center gap-1 shadow-xs transition-all active:scale-95"
                          >
                  ...
                  filteredLeads.map((lead) => (
                    <tr key={lead.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="p-4 text-center">
                        <button
                          onClick={() => handleConvertLeadToVipCustomer(lead)}
                          className="px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-white font-bold text-xs rounded-xl flex items-center gap-1 shadow-xs transition-all mx-auto"
                        >
      ...
      {isLogDrawerOpen && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-xl shadow-2xl border border-slate-200 w-full max-w-3xl overflow-hidden my-6 flex flex-col max-h-[85vh] animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-base text-slate-900">Nhật Ký Lịch Sử Chuyển Trạng Thái</h3>
          ...
          <div className="bg-white rounded-xl shadow-2xl border border-slate-200 w-full max-w-2xl overflow-hidden my-8 animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-base text-slate-900">Tạo Lead Mới Phễu 7 Bước</h3>
